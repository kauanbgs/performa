                ...
                <header>
                  ...
                  />
                    ...
                    <h1
                      ...
                      className="font-primary text-xl text-white font-secondary font-semibold leading-[1.1] fixed bottom-47 outline-none focus:bg-white/10 rounded px-1 transition-colors"
                    >
                      {content.title}
                    </h1>
                    <section className="fixed bottom-40 flex gap-1">
                      {Array.from({ length: rating }).map((_, index) => (
                        <Star key={index} className="w-5 h-5 text-green-500 fill-green-500" />
                      ))}
                    </section>
                <footer className="ml-4 fixed bottom-5 mr-4 flex flex-col items-center">
                  <div className="flex items-center gap-1 fixed bottom-33">
                    <div className="w-20 h-[.5px] bg-[#a3a0a0]"></div>
                    <h1 className="text-[#a3a0a0] text-sm font-secondary font-semibold">ON</h1>
                    <div className="w-20 h-[.5px] bg-[#a3a0a0]"></div>
                  </div>
                  <img className="w-40 h-40 mr-3 mb-3" src="letterboxd.png" alt="letterboxd" />
                </footer>
              </div>
            </div>
    )}